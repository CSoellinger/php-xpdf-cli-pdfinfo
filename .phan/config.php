...
return [
    ...
    'directory_list' => [
        ...
        'tests',
        // '.phan/stubs',
        // 'vendor/jetbrains/phpstorm-stubs/soap',
        'vendor/phpunit/phpunit/src/Framework',
        'vendor/insign/get-os/src',
        'vendor/symfony/process',
        // 'vendor/silverstripe/framework/src/Core',
        // 'vendor/silverstripe/framework/src/Core',
        // 'vendor/silverstripe/framework/src/i18n',
        // 'vendor/silverstripe/framework/src/View',
        // 'vendor/symfony/expression-language',
    ],
    ...
    'autoload_internal_extension_signatures' => [
        ...
        'soap'        => 'vendor/jetbrains/phpstorm-stubs/soap/soap.php',
